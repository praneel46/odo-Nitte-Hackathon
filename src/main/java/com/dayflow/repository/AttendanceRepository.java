...
public interface AttendanceRepository extends JpaRepository<Attendance, Long> {
    ...
    List<Attendance> findByEmployeeIdOrderByDateDesc(Long userId);
    List<Attendance> findByEmployeeIdAndDateBetween(Long userId, LocalDate startDate, LocalDate endDate);
